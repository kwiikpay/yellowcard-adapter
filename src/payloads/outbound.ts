 ...
 */
export function buildOutboundPaymentPayload(
  opts: BuildOutboundPaymentPayloadOptions,
  ...
  const accountType: "momo" | "bank" =
    beneficiary.phoneNumber && !beneficiary.accountNumber ? "momo" : "bank";
