 ...
 */
export declare function parseYcWebhookPayload(raw: unknown): YcWebhookEvent;
/**
 ...
 */
export declare function classifyKindFromSequenceId(sequenceId: string): "inbound" | "outbound" | "unknown";
