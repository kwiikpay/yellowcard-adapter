 ...
 */
export declare function normalizeKycFromUserMetadata(meta: Record<string, unknown> | null | undefined, email: string): YcKycFields;
/**
 ...
 */
export declare function deriveCustomerName(kyc: YcKycFields, fallback?: string): string;
